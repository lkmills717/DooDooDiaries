class Movement < ApplicationRecord
    ...
    def hints
        ...
        constipations_hints = ["Try to get at least 25 to 31 grams of fiber per day", "Increase your physical activity level.", "Always use the bathroom when you get the urge to go — don’t try and hold it.", "If constipation or diarrhea become your consistent stool pattern, talk to your primary care doctor. Your doctor may recommend treatments or refer you to a specialist (called a gastroenterologist) who can perform further testing."]
